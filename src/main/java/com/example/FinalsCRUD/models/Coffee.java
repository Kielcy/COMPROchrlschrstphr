package com.example.FinalsCRUD.models;
...
public class Coffee {
     ...
     * @param imagePath   The path to the coffee image file.
     */
    public Coffee(int id, String name, String type, String size, double price, String roastLevel, String origin, boolean isDecaf, int stock, List<String> flavorNotes, String brewMethod, String imagePath) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.size = size;
    ...
    /**
     * Constructs a Coffee object without an image path.
     * This constructor is used for backward compatibility.
     */
    ...
    /**
     * Gets the image path for the coffee.
    ...
    /**
     * Sets the image path of the coffee.
